...
// Keep generated handwriting visibly lighter than the user's ordinary pen.
// Xochitl still applies the active tool's own width curve, so this needs
// physical-device calibration whenever that input path changes.
pub const DRAW_PRESSURE: i32 = 1400;
