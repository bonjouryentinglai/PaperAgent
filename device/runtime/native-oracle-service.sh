...
export PAPER_AGENT_CJK_SCALE=${PAPER_AGENT_CJK_SCALE:-0.70}
export PAPER_AGENT_TEXT_SCALE_PERCENT=${PAPER_AGENT_TEXT_SCALE_PERCENT:-100}
export PAPER_AGENT_MIN_AUTO_SCALE_PERCENT=${PAPER_AGENT_MIN_AUTO_SCALE_PERCENT:-60}
