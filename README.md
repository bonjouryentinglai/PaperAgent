...
- **Beautify** treats the selection as source material only. It copies text in
  a handwriting face or reconstructs a sketch as native vector ink; it never
  answers the selected content.
...
| Beautify text or sketch | Routed separately; currently creates a copy beside the original |
